...
<body>
    ...
    <form method="post" action="">
        <label for="nouveauFilm">Titre du nouveau film :</label>
        <input type="text" id="nouveauFilm" name="nouveauFilm" required>
    ...
    String nouveauFilm = request.getParameter("nouveauFilm");
    String anneeNouveauFilm = request.getParameter("anneeNouveauFilm");
    if (nouveauFilm != null && anneeNouveauFilm != null && !nouveauFilm.isEmpty() && !anneeNouveauFilm.isEmpty()) {
        try {
            ...
            pstmtExercice4.setString(1, nouveauFilm);
            pstmtExercice4.setInt(2, anneeNouveau);
            int rowsAffected = pstmtExercice4.executeUpdate();

            if (rowsAffected > 0) {
                out.println("<p>Le nouveau film a été ajouté avec succès.</p>");
            } else {
                out.println("<p>Erreur : Le film n'a pas pu être ajouté.</p>");
            }
